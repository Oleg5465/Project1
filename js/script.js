...
//       //кладемо відповіді в пустий масив!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// const arr = [];
...
//       //Прийом інтерполяції(ES6)!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// const num = "test";
// const arr = 5;
// const arrNew = "true";

// console.log(`У мене сьогодні:${num} з програмування. Я його здав на ${arr}. І сьогодні я п*ю ${arrNew}!`)

      //Оператори в JS!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// console.log("test" + "cool"); //додасть дві строки
// console.log(5 + + "5"); // завдяки унарному плюсу, ми отримали число 10

      //Оператори фнкременту та декременту
// let incr = 10;
// let decr = 15;
// incr++;// опер. іникременту(постфіксна форма)
// decr--;// опер. декременту(постфіксна форма)
// console.log(incr, decr); // постфіксна форма спочатку вертає нам старе значення, а потім додоає(віднімає)

// let incr = 10;
// let decr = 15;
// ++incr;// опер. іникременту(префіксна форма)
// --decr;// опер. декременту(префіксна форма)
// console.log(incr, decr);// префіксна форма, спочатку додає(віднімає)а потім аж вертає знач.

// || - означ "або"
// && - означ "i"
// ! - опер. отрецания. Брехню перетвор.в правду, і навпаки
// != - означ. не дорівнює
